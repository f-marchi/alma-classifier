...
Got **.idat** files? Use our automatic [platform](https://almagenomics.com/) or process manually with [SeSAMe](https://github.com/zwdzwd/sesame) first.
...
Got **.bam** files? Use our automatic [platform](https://almagenomics.com/) or process manually with [modkit](https://nanoporetech.github.io/modkit/intro_pileup.html) first:
